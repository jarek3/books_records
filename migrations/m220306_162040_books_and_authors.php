...
class m220306_162040_books_and_authors extends Migration
{
  ...
  $this->execute (INSERT INTO `books` (`id`, `title`, `author`, `description`) VALUES
    (1, 'Learn PHP 8', 'Steve Prettyman', 'In this book you will create a complete three-tier application using a natural process of building and testing modules within each tier.'),
  ...
  $this->execute (INSERT INTO `authors` (`id`, `name`, `surname`) VALUES
    (1, 'Steve', 'Prettyman'),
    (2, 'Jan', 'Hocek');
    );
